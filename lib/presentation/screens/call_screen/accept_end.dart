                ...
                children: [
                  ...
                  Padding(
                      ...
                      child: Column(children: [
                        ...
                        Text("Waiting",style: AppStyles.style16.copyWith(color: HexColor(AppColors.boldColor)),),
                      ],)
                  ),
                ],
              ),
              ...
              children: [
                Expanded(
                    ...
                    style: const ButtonStyle(
                      backgroundColor: MaterialStatePropertyAll(Color.fromRGBO(10, 10, 10, 0))
                    ),
                        child: CircleAvatar(
                            radius: 30,
